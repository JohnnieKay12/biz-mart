    ...
    return (
        <div className='text-sm border rounded-md border-darkBlue/20 group bg-white'>
            ...
            <div className='p-3 flex flex-col gap-2'>
                {product?.categories && (
                    <p className="uppercase line-clamp-1 text-xs font-medium text-lightText text-shop-light_text">
                        ...
                        <StarIcon
                            ...
                            className={
                                index < 4 
                                    ...
                                    : " text-shop-lighter_text"
                            }
                            fill={index < 4 ? "#93D991" : "#ababab"}
                        /> 
                    ))}
                    </div>
                    <p className='text-shop-light_text text-xs tracking-wide'>
                        5 Reviews
                    </p>
                </div>
