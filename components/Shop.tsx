    ...
    return (
        <div className="border-t">
            <Container className="mt-5">
                {/* HEADER */}
                <div className="sticky top-0 z-10 mb-5 bg-white">
                    <div className="flex items-center justify-between">
                        ...
                        {(selectedCategory || selectedBrand || selectedPrice) && (
                            <button
                                ...
                                className="text-shop_dark_green underline text-sm font-medium hover:text-darkRed"
                            >
                                Reset Filters
                            </button>
                        )}
                ...
                <div className="fixed inset-0 z-50 bg-white overflow-y-auto">
                    ...
                    <div className="sticky bottom-0 p-4 border-t bg-white">
                        <button
                            ...
                            className="w-full bg-shop_dark_green text-white py-3 rounded-md"
                        >
                            Apply Filters
                        </button>
                    </div>
